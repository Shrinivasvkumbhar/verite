    ...
    <div class="nav" ref="menu">
        <div class="menu" >
            <div class="flex flex-col gap-[10px] text-center">
                ...
                <a href="/Verite/games" class="nav-item" ref="navItem2">
                    <h1 class="menu-title">Games</h1>
                </a>
                <a href="/Verite" class="nav-item" ref="navItem3">
                    <h1 class="menu-title">Blogs</h1>
                </a>
                <a href="/Verite" class="nav-item" ref="navItem4">
...
<style>
@import url("../../assets/css/menu.scss");
</style>
